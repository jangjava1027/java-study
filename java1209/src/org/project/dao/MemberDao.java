...
public class MemberDao {
	...
	public int BoardwriteDo(String writeId, String bContent) {
		int result = 0;
		Connection conn = null;
		PreparedStatement pstm = null;
		String query = "";
		...
		try {
			conn = DBConnect.getConnection();
			query = "insert into board1207 values(board_seq.nextval,?,?)";
			pstm = conn.prepareStatement(query);
	...
	public int BoardwriteDo(String bTitle, String bContent, String bWriteId) {
		int result = 0;
		...
		try {
			conn = DBConnect.getConnection();
			query = "insert into board01 values(board01_seq.nextval,?,?,?)";			
			// transtion - >spring boot
